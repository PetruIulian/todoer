...
class _$CreateUserStart implements CreateUserStart {
  ...
  @override
  String toString() {
    return 'CreateUser(displayName: $displayName, email: $email, password: $password, response: $response)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, displayName, email, password, response);
  ...
  TResult when<TResult extends Object?>(
    ...
    return $default(displayName, email, password, response);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>(
    ...
    return $default?.call(displayName, email, password, response);
  }
